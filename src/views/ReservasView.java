...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		JLabel lbValorSimbolo = new JLabel("S/.");
		lbValorSimbolo.setVisible(true);
		lbValorSimbolo.setBounds(121,332,17,25);
		lbValorSimbolo.setForeground(SystemColor.textHighlight);
		lbValorSimbolo.setFont(new Font("Roboto", Font.BOLD, 17));
		panel.add(lbValorSimbolo);
	...
	private void guardarReserva() {
		if(txtFechaEntrada.getDate() != null && txtFechaSalida.getDate() != null && !txtValor.equals("") 
			...
			JOptionPane.showConfirmDialog(this, "Debes llenar todos los campos");
		}
	}
	...
	//actualizacion de las fechas de la tabla, se limpie el valor
